...
# 26/09/2019: khy: Altered the original to include bookmark_r and deletemark_r
# sp I can OVERWRITE existing bookmark with new contents. The original appends to end of file.
# bookmark_r calls deletemark_r to remove bookmark - if exist - and then appends new
# bookmark to end of file.
# A new alias is created to call bookmark_r.
#
# ------------------------------------------------------------------------------
